...
@XmlType(name = "TemplateContainer", namespace = "http://www.tmg.com/coreservices/data")
@XmlRootElement(name = "TemplateContainer", namespace = "http://www.tmg.com/coreservices/data")
public class TemplateContainer<T> {
	...
	public TemplateContainer(Integer pagesCount, Long totalItems,
