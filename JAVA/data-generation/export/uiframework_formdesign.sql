...
--
-- Table structure for table `formdesign`
--

DROP TABLE IF EXISTS `formdesign`;
...
--
-- Dumping data for table `formdesign`
--

LOCK TABLES `formdesign` WRITE;
/*!40000 ALTER TABLE `formdesign` DISABLE KEYS */;
/*!40000 ALTER TABLE `formdesign` ENABLE KEYS */;
UNLOCK TABLES;
