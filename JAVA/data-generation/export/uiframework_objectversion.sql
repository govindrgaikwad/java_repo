...
DROP TABLE IF EXISTS `objectversion`;
...
--
-- Dumping data for table `objectversion`
--

LOCK TABLES `objectversion` WRITE;
/*!40000 ALTER TABLE `objectversion` DISABLE KEYS */;
/*!40000 ALTER TABLE `objectversion` ENABLE KEYS */;
UNLOCK TABLES;
