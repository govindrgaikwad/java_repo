...
--
-- Table structure for table `uielementtype`
--
...
CREATE TABLE `uielementtype` (
  `UIElementTypeID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `uielementtype`
--

LOCK TABLES `uielementtype` WRITE;
/*!40000 ALTER TABLE `uielementtype` DISABLE KEYS */;
/*!40000 ALTER TABLE `uielementtype` ENABLE KEYS */;
UNLOCK TABLES;
