...
--
-- Table structure for table `operatortype`
--
...
CREATE TABLE `operatortype` (
  `OperatorTypeID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `operatortype`
--

LOCK TABLES `operatortype` WRITE;
/*!40000 ALTER TABLE `operatortype` DISABLE KEYS */;
/*!40000 ALTER TABLE `operatortype` ENABLE KEYS */;
UNLOCK TABLES;
