...
CREATE TABLE `validator` (
  `ValidatorID` int(11) NOT NULL AUTO_INCREMENT,
  `UIElementID` int(11) NOT NULL,
  `IsRequired` tinyint(1) DEFAULT NULL,
  `Regex` varchar(200) DEFAULT NULL,
  `IsLibraryRegex` tinyint(1) DEFAULT NULL,
  `LibraryRegexID` int(11) DEFAULT NULL,
  ...
  KEY `FK_Validator_RegexLibrary` (`LibraryRegexID`),
  KEY `FK_Validator_UIElement` (`UIElementID`),
  CONSTRAINT `FK_Validator_RegexLibrary` FOREIGN KEY (`LibraryRegexID`) REFERENCES `regexlibrary` (`LibraryRegexID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Validator_UIElement` FOREIGN KEY (`UIElementID`) REFERENCES `uielement` (`UIElementID`) ON DELETE NO ACTION ON UPDATE NO ACTION
